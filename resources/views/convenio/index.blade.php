...
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="float-ring">    
               @include('convenio.create')
               @include('convenio.create2')
            </div>
             <br>
            <table id="convenios" class="table table-striped">
                <thead>
                    <th>Nro. Folio</th>
                ...
                <tbody align="center">
                    @foreach ($convenio as $conv)
                        <tr>
                            ...
                            <td>
                                @include('convenio.edit', [$conv->id])
                                @include('convenio.show', [$conv->id])
                               
                                <form action="{{ url('convenios/' . $conv->id) }}" class="d-inline " method="post">
                                    @csrf
                                    {{ method_field('DELETE') }}
