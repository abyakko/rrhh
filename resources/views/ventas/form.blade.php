...
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        {!! Form::text('nombre', null, ['id'=>'nombre','name'=>'nombre','class'=>'form-control', 'placeholder'=>'Nombre de la Empresa','oninput'=>'this.value = this.value.toUpperCase();','style'=>'text-transform:uppercase;', 'required' ]) !!}
    </div>
    </div>
    <div class="form-group col-md-6">
        <div class="input-group mb-3">
