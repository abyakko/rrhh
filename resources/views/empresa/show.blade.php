...
<div class="modal fade" id="showModal{{$emp->id}}"  tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="align: center; background-color: black">
                <h4 class="modal-title" id="staticBackdropLabel" style="text-align: center; font-size: 20px; color: orange;">DESCRIPCIÓN DE LA EMPRESA</h4>    
            </div>
